...
if __name__ == '__main__':
    ...
    albert_einstein = Student(
        ...
        grade=6,
        birthday=datetime(year =1879, month =4, day =18),
        )
    ...
    #another method to list all students 
